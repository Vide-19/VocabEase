...
public class MenuQuery extends BaseParam {
	...
	private Boolean formatter2Tree;
	public Boolean getFormatter2Tree() {
		return formatter2Tree;
	}
	public void setFormatter2Tree(Boolean formatter2Tree) {
		this.formatter2Tree = formatter2Tree;
	}
