...
public class Constants {
    ...
    public static final String[] EXCEL_TITLE_WORD = new String[] {"单词", "音标（可空）", "词性（可空）", "中文释义", "例句（可空）", "难度", "分类"};
    public static final String[] EXCEL_TITLE_QUESTION = new String[] {"标题", "问题描述", "问题类型", "问题选项", "答案解析", "答案", "难度", "分类"};
