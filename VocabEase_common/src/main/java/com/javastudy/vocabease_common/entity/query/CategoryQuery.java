...
public class CategoryQuery extends BaseParam {
	...
	private Integer excludeCategoryId; // 用于更新时排除自身
	...
	public Integer getExcludeCategoryId() {return excludeCategoryId;}

	public void setExcludeCategoryId(Integer excludeCategoryId) {this.excludeCategoryId = excludeCategoryId;}
