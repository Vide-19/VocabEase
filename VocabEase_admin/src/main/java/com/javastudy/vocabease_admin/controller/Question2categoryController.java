...
public class Question2categoryController extends ABaseController{
	...
	public ResponseVO<PaginationResultVO<Question2category>> loadDataList(Question2categoryQuery query){
	 ...
	 */
	@RequestMapping("/add")
	public ResponseVO<Void> add(Question2category bean) {
	...
	public ResponseVO<Void> addBatch(@RequestBody List<Question2category> listBean) {
	...
	public ResponseVO<Void> addOrUpdateBatch(@RequestBody List<Question2category> listBean) {
		question2categoryService.addBatch(listBean);
		return getSuccessResponseVO(null);
	}
	...
	public ResponseVO<Question2category> getQuestion2categoryByQuestionIdAndCategoryId(Integer questionId,Integer categoryId) {
	...
	public ResponseVO<Void> updateQuestion2categoryByQuestionIdAndCategoryId(Question2category bean,Integer questionId,Integer categoryId) {
	...
	public ResponseVO<Void> deleteQuestion2categoryByQuestionIdAndCategoryId(Integer questionId,Integer categoryId) {
